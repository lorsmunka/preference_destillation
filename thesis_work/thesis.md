...
A post generation domain ezzel szemben lényegesen nehezebben skálázható. Egy 32 példás post generation batch körülbelül 512 MB, miközben a strukturált sentiment és math batchek mérete jellemzően 5-6 MB. Emiatt a free-form generálás statisztikailag rigorózusabb tesztelését jelenleg főleg a distillation data előállításának és a tanításnak az idő- és tárhelyigénye korlátozza. A korai top-k elemzés alapján a KL/CE annealing és temperature annealing kombinációja free-form szövegen bíztató javulást mutat, mert egyszerre támogatja a következő-token predikció élesítését és a teacher eloszlásának követését. Ez a "best of both worlds" jellegű eredmény ígéretes, de további futtatások szükségesek ahhoz, hogy statisztikailag is erősen alátámasztható legyen.
...
A redukált vocabulary nem automatikus optimalizáció, hanem domain coverage döntés. A tanítás előtt meg kell határozni, hogy a domainben várhatóan milyen input és output tokenekre lesz szükség: ez történhet nagyobb mintaszöveg tokenizálásával, domainismeret alapján kiválasztott tokenekkel, vagy annak elfogadásával, hogy ritka, nem lefedett példák kiesnek a tanításból vagy inference közben nagyobb modellhez kerülnek. Így a vocabulary redukció előnye a kisebb modellméret, a korlátja pedig az, hogy a modell csak a lefedett részdomainen értelmezhető.
...
4. Táblázat: teljes és redukált input vocabulary futtatások összehasonlítása
...
5. Grafikonok
Ez a fejezet a kísérletek fő eredményeit vizuálisan foglalja össze. A cél nem a projektben található összes futtatás bemutatása, hanem a dolgozat fő állításainak alátámasztása: a vocabulary redukció paraméterhatása, a strukturált domainek korai telítődése, a KL/CE veszteségek közötti kis különbség strukturált kimeneteknél, a free-form post generation eltérő top-k viselkedése, valamint az adatgenerálás erőforrás-korlátja.
